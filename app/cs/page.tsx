...
export const metadata: Metadata = {
  title: "Studio Platform — Produktové systémy pro skutečný provoz",
  description: "Navrhujeme a stavíme interní systémy, klientské portály a automatizace pro organizace, které přerostly tabulky a nespojené nástroje.",
  alternates: {
    canonical: "/cs",
...
const process = ["Pochopit", "Ověřit", "Navrhnout", "Postavit", "Prověřit", "Spustit", "Zlepšovat"];
  ...
  return (
    <main lang="cs">
      ...
      <section className="hero shell" id="top">
        ...
        <div className="hero-grid">
          ...
          <div className="hero-actions">
            <Link className="button button-primary" href="/cs/kontakt">Začít Discovery Sprint</Link>
            <Link className="button button-secondary" href="/cs/pripadove-studie/ck-pragotour">Prozkoumat případovou studii</Link>
          </div>
        </div>
      ...
      <section className="section shell proof" id="proof">
        <div className="proof-intro"><span className="kicker">Důkaz místo slibů</span><h2>CK Pragotour</h2><p>Komplexní provozní systém pro cestovní kancelář: katalog, poptávky, objednávky, finance, dokumenty, platby účastníků a administrace.</p><Link className="text-link" href="/cs/pripadove-studie/ck-pragotour">Otevřít případovou studii ↗</Link></div>
      ...
      <section className="closing"><div className="shell closing-inner"><span className="kicker">Máte systém, který už brzdí provoz?</span><h2>Pojďme nejdřív zjistit,<br />co má smysl stavět.</h2><Link className="button button-light" href="/cs/kontakt">Probrat projekt ↗</Link></div></section>
